  ...
  return (
    <div className="max-w-2xl mx-auto">
      <p className="text-xs text-slate-500 mb-4 leading-relaxed bg-slate-50 border border-slate-200 rounded-lg px-3 py-2">
        ...
        עם מקומות שמורים לנציגי מרצ (6, 8, 14) ול-4 נציגי מיעוטים ונציג/ת כפרי אחד/ת, ממוינים יחד (12, 13, 18, 23, 27). לאחר כל מקום שמור, המקום הבא מוקצה למגדר הנגדי.
      </p>
